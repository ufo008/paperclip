  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        <h1 className="text-xl font-semibold">{t('instance.setupRequired')}</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          {hasActiveInvite
            ? t('instance.bootstrapInviteActive')
            : t('instance.runCommand')}
        </p>
...
function OnboardingRoutePage() {
  ...
  const title = matchedCompany
    ? t('onboarding.addAnotherAgent', { company: matchedCompany.name })
    : companies.length > 0
...
function NoCompaniesStartPage() {
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        <h1 className="text-xl font-semibold">{t('onboarding.createFirst')}</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          {t('onboarding.getStarted')}
        </p>
        <div className="mt-4">
          <Button onClick={() => openOnboarding()}>{t('onboarding.createCompany')}</Button>
        </div>
      </div>
    </div>
  );
